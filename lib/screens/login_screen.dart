    ...
    class _LoginScreenState extends State<LoginScreen> {
      ...
      Future<void> loginUser() async{
        ...
        //comapres the entered details with all the predefined credentials
        for (var user in users){
      ...
      //controllers are disposed after login is successful
      @override
      void dispose() {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Center(child: Image.asset("assets/images/logo.jpg",height: 220,)),
                  ...
                  TextField(
                    ...
                    obscureText: isPasswordHidden, // hide password
                    decoration: InputDecoration(
                    ...
                    onSubmitted: (_) => loginUser(), // press ENTER to submit form
                  ),
                  

                  SizedBox(height: 15),
                  //The Row widget is used to create a horizontal layout for the "Remember Me" checkbox.
                  Row(
